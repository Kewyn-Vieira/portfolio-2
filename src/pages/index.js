        ...
        <StyledReview>
            ...
            <Row justifyContent='flex-start' alignItems='center' height='51px'>
                ...
                <Column margin='0 0 0 16px' alignItems='flex-start' justifyContent='space-evenly' height='100%'>
                    <StyledA fontWeight='600' fontSize='14px' margin='0' textAlign='left'>Regina Miles</StyledA>
                    ...
                    <Container>
                        <Row justifyContent='space-between' alignItems='center' flexWrap='nowrap'>
                            ...
                            <Row width='70%' justifyContent='space-between' flexWrap='nowrap'>
                                <StyledUl>
                                    <li>
                                        <StyledA color={({theme}) => theme.colors.textSecondary} fontSize='14px' fontWeight='600'>
                                            Home
                                        </StyledA>
                                    </li>
                                    <li>
            ...
            <footer>
                <Section>
                    <Column>
                        ...
                        <StyledP>the quick fox jumps over the lazy dog</StyledP>
                        <Row>
